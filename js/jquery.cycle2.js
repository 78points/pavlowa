...
/////////////////////  TA LINIA BUDUJE POSZCZEGULNE SLIDY ZE ZBIORU ZDJEC ///////////////////////////////////
$('#galery-slideshow > a').each(function(i) {
$(this).attr('data-toggle', 'lightbox');
$(this).attr('data-gallery', 'multiimages');
});


$('#galery-slideshow > a > img').each(function(i) {
    var img_sr = $(this).attr('src');
    console.log(img_sr);
  $(this).parent().html('<div class="img_1a"><div class="image-frame"></div><img src="'+img_sr+'"></div>');  
   // $(this).andSelf().wrap('<div class="img_1a"></div>');

});

$('div.cycle-slideshow > a').each(function(i) {
 // console.log('image');
    if( i % 12 == 0 ) {
        $(this).nextAll().andSelf().slice(0,12).wrapAll('<div id="gallery-single-slide"></div>');
    }
});
//////////////////////////////////////////////////////////////////////////////////////////////////////////
