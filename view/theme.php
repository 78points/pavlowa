...
<div class="tools">
<a data-toggle="modal" href="#modal1"><i class="fa fa-cog"></i></a>
...
<h2>Smple <span class="bol">form box</span></h2>
...
<div class="col-sm-11 tiles-holder">
<div class="col-sm-12 tiles white">
...
<!-- //////////// -->
 ...
 <p class="bs-component">
              <a href="#" class="btn btn-default btn-shadow">Default</a>
              <a href="#" class="btn btn-primary btn-shadow">Primary</a>
              <a href="#" class="btn btn-success btn-shadow">Success</a>
              <a href="#" class="btn btn-info btn-shadow">Info</a>
              <a href="#" class="btn btn-warning btn-shadow">Warning</a>
              <a href="#" class="btn btn-danger btn-shadow">Danger</a>
              <a href="#" class="btn btn-link btn-shadow">Link</a>
            </p>           
...
<p class="bs-component">
                            ...
                            <button class="btn btn-primary btn-circle" type="button"><i class="fa fa-plus"></i>
                            </button>
...
<p class="bs-component">
                            ...
                            <button class="btn btn-primary btn-circle btn-lg" type="button"><i class="fa fa-plus"></i>
                            </button>
...
<p class="bs-component">
                            ...
                            <button class="btn btn-default btn-circle btn-shadow" type="button"><i class="fa fa-check"></i>
                            </button>
                            <button class="btn btn-primary btn-circle btn-shadow" type="button"><i class="fa fa-plus"></i>
                            </button>
                            <button class="btn btn-success btn-circle btn-shadow" type="button"><i class="fa fa-link"></i>
                            </button>
                            <button class="btn btn-info btn-circle btn-shadow" type="button"><i class="fa fa-check"></i>
                            </button>
                            <button class="btn btn-warning btn-circle btn-shadow" type="button"><i class="fa fa-times"></i>
                            </button>
                            <button class="btn btn-danger btn-circle btn-shadow" type="button"><i class="fa fa-heart"></i>
                            </button>
</p>
      ...
      <div class="bs-docs-section">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="bs-component">
              <h1>Heading 1 <strong>strong</strong> <small>small sample</small></h1>
              <h2>Heading 2</h2>
              <h3>Heading 3</h3>
              <h4>Heading 4</h4>
              <h5>Heading 5</h5>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="bs-component">
              ...
              <h2 id="tables">Table bordered </h2>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="bs-component">
              ...
              <div class="panel panel-default panel-shadow panel-colored">
                <div class="panel-body">
                  Basic panel .colored
                </div>
              </div> 
              ...
              <div class="panel panel-default panel-shadow panel-colored" style="color:green;">
               <div class="panel-sidebar">
                <i class="fa fa-ellipsis-v"></i>
                </div>
                <div class="panel-body" style="border-color:green;">
                  Basic panel .colored 
                </div>
              </div> 
...
<button type="button" class="btn btn-success btn-shadow btn-lg" data-toggle="modal" data-target="#myModal">
  Launch demo modal
</button>
